    ...
    public class MicroWaveCamera : ScopeHubBase
    {
        ...
        public void Start(double start, double stop, double step)
        {
            ...
            Task.Factory.StartNew(() =>
            {
                ...
                Task.Run(()=>System.IO.File.WriteAllText(System.IO.Path.Combine("data", path, "atomnumbersvsfreq.txt"), string.Join(Environment.NewLine, atomCounts.Select(x=>$"{x.F},{x.Count}")), System.Text.Encoding.ASCII));
